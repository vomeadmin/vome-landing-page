...
export const strings = {
  ...
  module_recruitment: {
    ...
    ben4_desc: { en: "New applicants are dropped straight into onboarding sequences automatically — no manual triage, status updates, or assignments needed.", fr: "Les nouveaux candidats sont automatiquement intégrés dans les séquences d'intégration — sans triage, mise à jour de statut ou affectation manuelle." },
    ...
    spot3_b2: { en: "Set up workflow automations tailored to how your program runs", fr: "Configurez des automatisations adaptées à votre programme" },
    ...
    spot3_b4: { en: "Data flows into your scheduling, messaging, database, and the rest of your portal", fr: "Les données alimentent votre planification, messagerie, base de données et le reste de votre portail" },
    ...
    diff1_title: { en: "All in one platform", fr: "Tout dans une seule plateforme" },
    ...
    diff2_desc: { en: "Most form tools stop at conditional fields. Vome layers on conditional automations — status changes, sequence assignments, and email templates that fire based on each answer.", fr: "La plupart des outils de formulaires s'arrêtent aux champs conditionnels. Vome ajoute des automatisations conditionnelles : statuts, séquences et modèles de courriels déclenchés par chaque réponse." },
  ...
  module_onboarding: {
    ...
    spot3_b3: { en: "Post-completion automations extend access to the right activities, jobs, and events the moment a volunteer is cleared", fr: "Des automatisations post-complétion donnent accès aux bonnes activités, emplois et événements dès qu'un bénévole est validé" },
    ...
    diff3_desc: { en: "Rochester Regional Health used Vome sequences to take volunteer onboarding from 6-8 weeks down to 1, and saved admins 10+ hours every week.", fr: "Rochester Regional Health a fait passer l'intégration des bénévoles de 6 à 8 semaines à 1 grâce aux séquences Vome, économisant 10+ heures par semaine aux administrateurs." },
  ...
  module_scheduling: {
    ...
    hero_h1_part1: { en: "Run ", fr: "Gérez " },
    hero_h1_accent: { en: "every shift", fr: "chaque quart" },
    hero_h1_part2: { en: ", from one-off to multi-site recurring.", fr: ", du ponctuel au récurrent multi-sites." },
    hero_sub: {
    ...
    hero_meta_recurring: { en: "One-time, recurring, and multi-site shifts", fr: "Quarts uniques, récurrents et multi-sites" },
    hero_meta_calendar: { en: "Google, Outlook & Apple calendar sync", fr: "Synchronisation Google, Outlook et Apple" },
    hero_meta_reminders: { en: "App and email reminders built in", fr: "Rappels par app et courriel intégrés" },
    ...
    chatroom_mock: {
      ...
      title: { en: "Morning floor companion · Mon Mar 9", fr: "Accompagnement matin · Lun 9 mars" },
      auto_label: { en: "Auto-generated · 4 attendees", fr: "Auto-généré · 4 participants" },
      ...
      msg3_text: { en: "Yes, please. Reminder: check in at the kiosk by 7:55 AM so we can start on time.", fr: "Oui, merci. Rappel : pointez à la borne avant 7 h 55 pour qu'on commence à l'heure." },
    ...
    // ── Benefits grid (6) ──
    benefits_h2: { en: "Everything your scheduling process requires.", fr: "Tout ce que votre processus de planification exige." },
    benefits_sub: {
      en: "From a single shift to recurring multi-site programs. Volunteers self-schedule, request approval, or admins pre-assign in bulk. Capacity, cancellations, and reminders are handled by Vome.",
      fr: "D'un seul quart aux programmes récurrents multi-sites. Les bénévoles s'auto-planifient, demandent une approbation, ou les admins affectent en lot. Capacité, annulations et rappels sont gérés par Vome.",
    },
    ben1_title: { en: "Recurring shifts in bulk", fr: "Quarts récurrents en lot" },
    ben1_desc: { en: "Generate one-time or weekly-recurring shifts in a few clicks. Set capacity, min and max attendees, and the date range to publish.", fr: "Générez des quarts uniques ou récurrents hebdo en quelques clics. Définissez capacité, minimum et maximum de participants et la plage de dates." },
    ben2_title: { en: "Self-schedule, request, or assign", fr: "Auto-planification, demande ou affectation" },
    ...
    ben3_desc: { en: "Control how many reservations a volunteer can hold, when they can check in, and how cancellations are handled per opportunity.", fr: "Contrôlez combien de réservations un bénévole peut détenir, quand il peut pointer et comment les annulations sont gérées par opportunité." },
    ben4_title: { en: "Group reservations", fr: "Réservations de groupe" },
    ben4_desc: { en: "Let one volunteer book on behalf of a team or family. Vome stores the group, the lead, and the party size on the shift.", fr: "Permettez à un bénévole de réserver pour une équipe ou une famille. Vome conserve le groupe, le responsable et la taille au quart." },
    ben5_title: { en: "Auto-shift chatrooms", fr: "Salons de quart automatiques" },
    ben5_desc: { en: "Each shift gets its own chatroom with attendees added automatically. Send last-minute updates without leaving the schedule view.", fr: "Chaque quart obtient son propre salon avec les participants ajoutés automatiquement. Envoyez les mises à jour de dernière minute sans quitter l'horaire." },
    ben6_title: { en: "Calendar sync, exports, and reminders", fr: "Synchronisation calendrier, exports et rappels" },
    ben6_desc: { en: "Volunteers sync to Google, Outlook, or Apple. Admins export to PDF, Excel, or CSV. App and email reminders fire on schedule.", fr: "Les bénévoles synchronisent vers Google, Outlook ou Apple. Les admins exportent en PDF, Excel ou CSV. Rappels par app et courriel automatiques." },

    // ── Spotlight 1: Build / create shifts ──
    spot1_kicker: { en: "BUILD", fr: "BÂTIR" },
    spot1_title: { en: "Build any schedule your program needs.", fr: "Bâtissez tout horaire dont votre programme a besoin." },
    spot1_body: {
    ...
    spot1_b1: { en: "One-time, recurring, or multi-site shifts in a single bulk action", fr: "Quarts uniques, récurrents ou multi-sites en une seule action en lot" },
    spot1_b2: { en: "Min and max capacity per shift, with waitlists when full", fr: "Capacité minimum et maximum par quart, avec liste d'attente si complet" },
    spot1_b3: { en: "Restrict visibility by tag, role, age, or site permission", fr: "Limitez la visibilité par étiquette, rôle, âge ou permission de site" },
    spot1_b4: { en: "Flexible scheduling: let approved volunteers propose their own times", fr: "Planification flexible : laissez les bénévoles approuvés proposer leurs disponibilités" },

    // ── Spotlight 2: Self-scheduling and instant booking ──
    spot2_kicker: { en: "BOOK", fr: "RÉSERVER" },
    spot2_title: { en: "Volunteers book the way you want them to.", fr: "Les bénévoles réservent de la façon dont vous le voulez." },
    spot2_body: {
      en: "Approved volunteers can <strong>book instantly</strong>, or every reservation can be <strong>routed for admin approval</strong>. Group reservations let one volunteer book for a team or family. Reservation limits and cancellation windows are enforced automatically per scheduling policy.",
      fr: "Les bénévoles approuvés peuvent <strong>réserver instantanément</strong>, ou chaque réservation peut être <strong>acheminée pour approbation admin</strong>. Les réservations de groupe permettent de réserver pour une équipe ou une famille. Les limites de réservation et fenêtres d'annulation sont appliquées automatiquement par politique.",
    },
    spot2_b1: { en: "Instant booking for approved volunteers, request approval otherwise", fr: "Réservation instantanée pour les bénévoles approuvés, demande d'approbation sinon" },
    spot2_b2: { en: "Group reservations: one volunteer books on behalf of a team or family", fr: "Réservations de groupe : un bénévole réserve pour une équipe ou une famille" },
    spot2_b3: { en: "Reservation limits per volunteer, per opportunity, per time window", fr: "Limites de réservation par bénévole, par opportunité, par plage" },
    spot2_b4: { en: "Cancellation windows and check-in rules enforced by policy", fr: "Fenêtres d'annulation et règles de pointage appliquées par politique" },
    ...
    spot3_body: {
      en: "Each shift gets an <strong>auto-generated chatroom</strong> with attendees added the moment they reserve. Send a last-minute update to everyone with one message. Volunteers sync the shift to <strong>Google, Outlook, or Apple Calendar</strong>, and Vome fires <strong>app and email reminders</strong> ahead of the shift.",
      fr: "Chaque quart obtient un <strong>salon généré automatiquement</strong> avec les participants ajoutés dès leur réservation. Envoyez une mise à jour de dernière minute à tous d'un seul message. Les bénévoles synchronisent le quart à <strong>Google, Outlook ou Apple Calendar</strong>, et Vome envoie des <strong>rappels par app et courriel</strong> avant le quart.",
    },
    spot3_b1: { en: "Auto-generated shift chatrooms with attendees added on reservation", fr: "Salons de quart générés automatiquement avec participants ajoutés à la réservation" },
    spot3_b2: { en: "Calendar sync to Google, Outlook, and Apple on the volunteer side", fr: "Synchronisation calendrier vers Google, Outlook et Apple côté bénévole" },
    spot3_b3: { en: "Bulk export the schedule to PDF, Excel, or CSV with custom fields", fr: "Exportez l'horaire en lot en PDF, Excel ou CSV avec champs personnalisés" },
    spot3_b4: { en: "App and email reminders for upcoming shifts and check-in windows", fr: "Rappels par app et courriel pour les quarts à venir et les fenêtres de pointage" },

    // ── How it works (4 steps) ──
    how_h2: { en: "How it works", fr: "Comment ça fonctionne" },
    how_sub: {
      en: "Build the shifts. Set the policy. Volunteers reserve. Vome handles the rest.",
      fr: "Bâtissez les quarts. Définissez la politique. Les bénévoles réservent. Vome fait le reste.",
    },
    ...
    diff2_title: { en: "Group reservations native", fr: "Réservations de groupe natives" },
    diff2_desc: { en: "One volunteer books for a team, family, or corporate group. Vome stores the lead, party size, and group name on the shift, with permissions tied to your sites.", fr: "Un bénévole réserve pour une équipe, une famille ou un groupe corporatif. Vome conserve le responsable, la taille et le nom du groupe au quart, avec permissions liées à vos sites." },
    diff3_title: { en: "Wired to messaging and check-in", fr: "Connecté à la messagerie et au pointage" },
    diff3_desc: { en: "Each shift carries its own chatroom and check-in window. Volunteers scan a QR code or self check in from a kiosk, and hours are logged automatically.", fr: "Chaque quart a son salon et sa fenêtre de pointage. Les bénévoles scannent un code QR ou pointent depuis une borne, et les heures sont consignées automatiquement." },
    ...
    faq5_q: { en: "Can volunteers sync shifts to their personal calendar?", fr: "Les bénévoles peuvent-ils synchroniser les quarts à leur calendrier personnel ?" },
    faq5_a: {
      en: "Yes. Each volunteer can sync their reserved shifts to Google Calendar, Outlook, or Apple Calendar. Updates and cancellations propagate automatically, and Vome still sends app and email reminders ahead of every shift.",
      fr: "Oui. Chaque bénévole peut synchroniser ses quarts réservés vers Google Calendar, Outlook ou Apple Calendar. Les mises à jour et annulations se propagent automatiquement, et Vome envoie quand même des rappels par app et courriel avant chaque quart.",
    },
    faq6_q: { en: "Can I export the schedule for printing?", fr: "Puis-je exporter l'horaire pour impression ?" },
    faq6_a: {
      en: "Yes. Export any view to PDF, Excel, or CSV. Choose which fields to include (attendees, reservation details, contact info, custom fields), filter by site or opportunity, and group by program for cleaner roster sheets.",
      fr: "Oui. Exportez toute vue en PDF, Excel ou CSV. Choisissez les champs à inclure (participants, détails de réservation, coordonnées, champs personnalisés), filtrez par site ou opportunité et groupez par programme pour des listes plus propres.",
    },
  ...
  module_hours: {
    ...
    hero_h1_part2: { en: ".", fr: "." },
    hero_sub: {
      en: "Pick the tools that fit. <strong>QR-code check-in</strong>, <strong>on-site kiosks</strong>, <em>volunteer hour claims</em>, <em>mass logging</em>, and <strong>GPS proximity validation</strong>. Every hour flows straight into reservation and hours reports.",
      fr: "Choisissez les outils qui conviennent. <strong>Pointage par code QR</strong>, <strong>bornes sur place</strong>, <em>déclarations d'heures</em>, <em>saisie en lot</em> et <strong>validation par proximité GPS</strong>. Chaque heure alimente directement les rapports de réservation et d'heures.",
    },
    hero_meta_qr: { en: "Same QR code every shift", fr: "Le même code QR à chaque quart" },
    hero_meta_kiosk: { en: "Unlimited kiosks, any device", fr: "Bornes illimitées, tout appareil" },
    hero_meta_reports: { en: "Reservation & hours reports", fr: "Rapports de réservation et d'heures" },
    ...
    benefits_sub: {
      en: "Some volunteers scan a QR code, others tap into a kiosk, a few send hour claims after the fact. Vome lets each program pick the method that fits, and pulls every hour into the same database and reports.",
      fr: "Certains bénévoles scannent un code QR, d'autres pointent à une borne, quelques-uns soumettent des déclarations après coup. Vome permet à chaque programme de choisir la méthode qui convient, et ramène chaque heure dans la même base de données et les mêmes rapports.",
    },
    ben1_title: { en: "QR-code check-in via the app", fr: "Pointage par code QR via l'app" },
    ben1_desc: { en: "Print one QR per site or shift. Volunteers scan it from the Vome app to check in and out, hands-free for your team.", fr: "Imprimez un code QR par site ou par quart. Les bénévoles le scannent depuis l'app Vome pour pointer leur entrée et leur sortie, sans intervention de votre équipe." },
    ben2_title: { en: "On-site kiosks on any device", fr: "Bornes sur place sur tout appareil" },
    ben2_desc: { en: "Turn any tablet, phone, or computer into a self-service kiosk. Volunteers search their name and tap to check in.", fr: "Transformez toute tablette, téléphone ou ordinateur en borne libre-service. Les bénévoles cherchent leur nom et pointent en un toucher." },
    ben3_title: { en: "Volunteer-submitted hour claims", fr: "Déclarations d'heures par les bénévoles" },
    ben3_desc: { en: "Volunteers can submit hours for shifts they completed on or off Vome. Approve them in one click and the time lands on their profile.", fr: "Les bénévoles peuvent soumettre des heures pour les quarts complétés sur ou hors Vome. Approuvez en un clic et le temps s'ajoute à leur profil." },
    ben4_title: { en: "Mass hour logging", fr: "Saisie d'heures en lot" },
    ben4_desc: { en: "Filter the attendee list, log hours for an entire shift in a few clicks, with accurate dates and times preserved.", fr: "Filtrez la liste des participants, consignez les heures pour un quart complet en quelques clics, dates et heures précises conservées." },
    ben5_title: { en: "GPS proximity validation", fr: "Validation par proximité GPS" },
    ben5_desc: { en: "Optionally require volunteers to be within range of the site before they can check in from their phone.", fr: "Exigez en option que les bénévoles soient à proximité du site avant de pouvoir pointer depuis leur téléphone." },
    ben6_title: { en: "Reservation & hours reports", fr: "Rapports de réservation et d'heures" },
    ben6_desc: { en: "Reports group hours by volunteer, opportunity, site, program, or any custom field. Export to Excel or sync to a Google Sheet.", fr: "Les rapports regroupent les heures par bénévole, opportunité, site, programme ou tout champ personnalisé. Exportez vers Excel ou synchronisez avec une feuille Google." },

    // ── Spotlight 1: CHECK IN. QR + mobile app ──
    spot1_kicker: { en: "CHECK IN", fr: "POINTER" },
    spot1_title: { en: "One QR code, every shift, every site.", fr: "Un code QR, à chaque quart, à chaque site." },
    spot1_body: {
      en: "Print the <strong>same daily QR code</strong> once and reuse it for every volunteer, every shift. Reserved attendees scan from the Vome app to check in and out automatically. <strong>GPS proximity</strong> keeps it honest, and an automatic check-out catches the ones who forget.",
      fr: "Imprimez le <strong>même code QR du jour</strong> une fois et réutilisez-le pour chaque bénévole, à chaque quart. Les participants réservés le scannent depuis l'app Vome pour pointer entrée et sortie automatiquement. La <strong>proximité GPS</strong> garde tout honnête, et le pointage de sortie automatique rattrape les oublis.",
    },
    spot1_b1: { en: "Reserved attendees scan to check in and out from the app", fr: "Les participants réservés scannent pour pointer entrée et sortie depuis l'app" },
    spot1_b2: { en: "Optional GPS proximity validation per site or shift", fr: "Validation par proximité GPS optionnelle par site ou par quart" },
    spot1_b3: { en: "Automatic check-out at the end of a shift if a volunteer forgets", fr: "Pointage de sortie automatique à la fin du quart en cas d'oubli" },
    spot1_b4: { en: "Hours flow straight to the volunteer profile, no manual entry", fr: "Les heures alimentent directement le profil du bénévole, sans saisie manuelle" },
    ...
    spot2_body: {
      en: "Volunteers submit hour claims for any shift they completed, even ones <strong>not booked through Vome</strong>. Each claim shows up in a queue with the shift, the volunteer, and the hours. Approve it and the time lands on their profile, ready for reports.",
      fr: "Les bénévoles soumettent des déclarations pour tout quart complété, y compris ceux <strong>non réservés via Vome</strong>. Chaque déclaration apparaît dans une file avec le quart, le bénévole et les heures. Approuvez et le temps s'ajoute à leur profil, prêt pour les rapports.",
    },
    spot2_b1: { en: "Claims for both Vome shifts and off-platform volunteering", fr: "Déclarations pour les quarts Vome et le bénévolat hors plateforme" },
    spot2_b2: { en: "One-click approve, decline, or request more info", fr: "Approuvez, refusez ou demandez plus d'info en un clic" },
    spot2_b3: { en: "Approved hours auto-log to the volunteer profile", fr: "Les heures approuvées s'ajoutent automatiquement au profil" },
    spot2_b4: { en: "Filter the queue by site, program, or custom tag", fr: "Filtrez la file par site, programme ou étiquette personnalisée" },
    ...
    spot3_body: {
      en: "Every check-in, claim, and bulk log feeds the same dashboard. Slice <strong>by site, program, opportunity, or custom field</strong>. Compare reservation counts to hours actually logged. Export to Excel or sync to a Google Sheet for your funders.",
      fr: "Chaque pointage, déclaration et saisie en lot alimente le même tableau de bord. Découpez <strong>par site, programme, opportunité ou champ personnalisé</strong>. Comparez les réservations aux heures réellement consignées. Exportez vers Excel ou synchronisez avec une feuille Google pour vos bailleurs.",
    },
    spot3_b1: { en: "Group hours by volunteer, opportunity, site, or program", fr: "Regroupez les heures par bénévole, opportunité, site ou programme" },
    spot3_b2: { en: "Compare reservations to hours actually logged", fr: "Comparez les réservations aux heures réellement consignées" },
    spot3_b3: { en: "Save filtered views with multi-site permissions", fr: "Sauvegardez des vues filtrées avec permissions multi-sites" },
    spot3_b4: { en: "Export to Excel or sync to a Google Sheet", fr: "Exportez vers Excel ou synchronisez avec une feuille Google" },
    ...
    diff_sub: {
      en: "Generic time-trackers ask volunteers to remember to start a timer. Vome wires check-in into the shift they already reserved, and into the reports your funders ask for.",
      fr: "Les outils de pointage génériques demandent aux bénévoles de penser à démarrer un chrono. Vome connecte le pointage au quart déjà réservé, et aux rapports que vos bailleurs demandent.",
    },
    ...
    diff3_title: { en: "Funder-ready reports", fr: "Rapports prêts pour les bailleurs" },
    diff3_desc: { en: "Group hours by site, program, or custom field. Export to Excel, sync a Google Sheet, or pull data through the API for grants and audits.", fr: "Regroupez les heures par site, programme ou champ personnalisé. Exportez vers Excel, synchronisez une feuille Google, ou tirez les données via l'API pour subventions et audits." },
    ...
    faq1_a: {
      en: "Print one QR per site, opportunity, or shift. Reserved attendees scan it from the Vome app on their phone to check in and out. The same QR code can be reused every shift, every day, with no need to print a new one. Hours log automatically on the volunteer's profile.",
      fr: "Imprimez un code QR par site, opportunité ou quart. Les participants réservés le scannent depuis l'app Vome pour pointer entrée et sortie. Le même code peut servir à chaque quart, chaque jour, sans réimprimer. Les heures s'enregistrent automatiquement sur le profil du bénévole.",
    },
    ...
    faq6_a: {
      en: "Every method (QR scan, kiosk, claim, bulk log) writes to the same volunteer profile and reservation record. Reports group hours by volunteer, opportunity, site, program, or custom field, and can be exported to Excel or synced to a Google Sheet for funders.",
      fr: "Chaque méthode (scan QR, borne, déclaration, saisie en lot) écrit dans le même profil et la même réservation. Les rapports regroupent les heures par bénévole, opportunité, site, programme ou champ personnalisé, et peuvent être exportés vers Excel ou synchronisés avec une feuille Google pour les bailleurs.",
    },
  ...
  module_recognition: {
    page_title: { en: "Volunteer recognition: achievements & custom awards | Vome", fr: "Reconnaissance des bénévoles : accomplissements et prix personnalisés | Vome" },
    page_description: {
      en: "Reward and motivate your volunteers with built-in Vome achievements that earn automatically as hours and shifts add up, plus the custom awards your team designs for personal moments.",
      fr: "Récompensez et motivez vos bénévoles avec les accomplissements Vome intégrés gagnés automatiquement à mesure que les heures et les quarts s'accumulent, et les prix personnalisés conçus par votre équipe pour les moments importants.",
    },

    // ── Hero ──
    hero_eyebrow: { en: "Recognition", fr: "Reconnaissance" },
    ...
    hero_h1_part2: { en: ".", fr: "." },
    hero_sub: {
      en: "Built-in <strong>Vome achievements</strong> that <em>your</em> volunteers earn automatically as hours, shifts, and milestones add up. Plus <strong>custom awards</strong> your team designs for the moments that matter most. Both render on profiles, ready to share.",
      fr: "<strong>Accomplissements Vome</strong> intégrés que <em>vos</em> bénévoles gagnent automatiquement à mesure que les heures, les quarts et les jalons s'accumulent. Plus les <strong>prix personnalisés</strong> conçus par votre équipe pour les moments qui comptent le plus. Les deux apparaissent sur les profils, prêts à partager.",
    },
    hero_meta_builtin: { en: "Built-in achievements ship out of the box", fr: "Accomplissements intégrés livrés dès le départ" },
    hero_meta_custom: { en: "Custom awards your team designs", fr: "Prix personnalisés conçus par votre équipe" },
    hero_meta_profile: { en: "Visible on every volunteer profile", fr: "Visibles sur chaque profil de bénévole" },

    // ── Hero mockup labels: volunteer profile wall ──
    wall_mock: {
      url: { en: "vomevolunteer.com/profile/achievements", fr: "vomevolunteer.com/profil/accomplissements" },
      ...
      vol_meta: { en: "248 hours · 32 shifts · 2 programs", fr: "248 heures · 32 quarts · 2 programmes" },
      section_earned: { en: "Earned", fr: "Gagnés" },
      section_progress: { en: "In progress", fr: "En cours" },
      a1_title: { en: "100 hours of service", fr: "100 heures de service" },
      a1_meta: { en: "Earned today", fr: "Gagné aujourd'hui" },
      a2_title: { en: "First shift", fr: "Premier quart" },
      a2_meta: { en: "Built-in", fr: "Intégré" },
      a3_title: { en: "5-year volunteer", fr: "Bénévole de 5 ans" },
      a3_meta: { en: "Custom award", fr: "Prix personnalisé" },
      a4_title: { en: "Hospital program lead", fr: "Responsable programme hospitalier" },
      a4_meta: { en: "Custom award", fr: "Prix personnalisé" },
      p1_title: { en: "250 hours of service", fr: "250 heures de service" },
      p1_progress: { en: "248 / 250 hours", fr: "248 / 250 heures" },
    ...
    // ── Spotlight 1 mockup: built-in achievement catalog ──
    cat_mock: {
      chip: { en: "BUILT-IN CATALOG", fr: "CATALOGUE INTÉGRÉ" },
      title: { en: "Vome achievements", fr: "Accomplissements Vome" },
      label: { en: "Earned automatically as volunteers track hours and shifts", fr: "Gagnés automatiquement quand les bénévoles consignent heures et quarts" },
      c1_name: { en: "First shift", fr: "Premier quart" },
      c1_rule: { en: "1 shift completed", fr: "1 quart complété" },
      c1_kind: { en: "Shifts", fr: "Quarts" },
      c2_name: { en: "10 hours of service", fr: "10 heures de service" },
      c2_rule: { en: "10 hours, all-time", fr: "10 heures, depuis toujours" },
      c2_kind: { en: "Hours", fr: "Heures" },
      c3_name: { en: "100 hours of service", fr: "100 heures de service" },
      c3_rule: { en: "100 hours, all-time", fr: "100 heures, depuis toujours" },
      c3_kind: { en: "Hours", fr: "Heures" },
      c4_name: { en: "10 shifts in a year", fr: "10 quarts dans une année" },
      c4_rule: { en: "10 shifts per calendar year", fr: "10 quarts par année civile" },
      c4_kind: { en: "Shifts", fr: "Quarts" },
      c5_name: { en: "Anniversary", fr: "Anniversaire" },
      c5_rule: { en: "1 year since first shift", fr: "1 an depuis le premier quart" },
      c5_kind: { en: "Tenure", fr: "Ancienneté" },
      c6_name: { en: "Program participant", fr: "Participant au programme" },
      c6_rule: { en: "5 hours in any program", fr: "5 heures dans un programme" },
      c6_kind: { en: "Programs", fr: "Programmes" },
      auto_badge: { en: "Auto", fr: "Auto" },
    },
    ...
    benefits_sub: {
      en: "Two complementary tools, one volunteer profile. Built-in Vome achievements run quietly in the background. Custom awards capture the moments only your team can see. Both feed the same shareable profile.",
      fr: "Deux outils complémentaires, un seul profil de bénévole. Les accomplissements Vome intégrés tournent discrètement en arrière-plan. Les prix personnalisés capturent les moments que seule votre équipe voit. Les deux alimentent le même profil partageable.",
    },
    ben1_title: { en: "Built-in achievements, ready on day one", fr: "Accomplissements intégrés, prêts dès le premier jour" },
    ben1_desc: { en: "First shift, hours of service, calendar-year shift counts, anniversaries. Vome ships a catalog of common milestones so volunteers earn recognition from their very first log.", fr: "Premier quart, heures de service, nombre de quarts par année, anniversaires. Vome livre un catalogue de jalons courants pour que les bénévoles reçoivent de la reconnaissance dès leur première consignation." },
    ben2_title: { en: "Custom awards your team designs", fr: "Prix personnalisés conçus par votre équipe" },
    ben2_desc: { en: "Add your own awards for the moments only you see. Pick a name, icon, description, and decide if Vome should issue them automatically or your coordinators send them by hand.", fr: "Ajoutez vos propres prix pour les moments que vous seuls voyez. Choisissez un nom, une icône, une description, et décidez si Vome les attribue automatiquement ou si vos coordonnateurs les envoient à la main." },
    ben3_title: { en: "Trigger on hours, shifts, or programs", fr: "Déclenchement par heures, quarts ou programmes" },
    ben3_desc: { en: "Set thresholds in hours or shifts, in any window: all-time, calendar year, rolling, or consecutive periods. Limit to a specific program, role, or site when needed.", fr: "Définissez des seuils en heures ou en quarts, sur toute fenêtre : depuis toujours, année civile, glissante ou périodes consécutives. Limitez à un programme, rôle ou site précis au besoin." },
    ...
    ben5_title: { en: "Visible on the volunteer profile", fr: "Visibles sur le profil du bénévole" },
    ben5_desc: { en: "Earned achievements and custom awards render on a wall in the volunteer's mobile and web profile, with progress shown for the next ones in line.", fr: "Les accomplissements gagnés et les prix personnalisés s'affichent sur un mur dans le profil mobile et web du bénévole, avec la progression des suivants à venir." },
    ben6_title: { en: "Eligibility scoped to the right people", fr: "Admissibilité ciblée aux bonnes personnes" },
    ben6_desc: { en: "Restrict any award to volunteers with a specific tag, role, site, or who finished a sequence. The catalog stays clean for everyone else.", fr: "Restreignez tout prix aux bénévoles ayant une étiquette, un rôle, un site précis ou ayant terminé une séquence. Le catalogue reste épuré pour les autres." },

    // ── Spotlight 1: Built-in achievements ──
    spot1_kicker: { en: "BUILT-IN", fr: "INTÉGRÉ" },
    spot1_title: { en: "A catalog of achievements that earn themselves.", fr: "Un catalogue d'accomplissements qui se gagnent tout seuls." },
    spot1_body: {
      en: "Every Vome account ships with a starter catalog: <strong>shift milestones</strong>, <strong>hour milestones</strong>, <strong>program participation</strong>, and <strong>anniversaries</strong>. Each one fires the moment a volunteer crosses the threshold, no admin work required.",
      fr: "Chaque compte Vome est livré avec un catalogue de départ : <strong>jalons de quarts</strong>, <strong>jalons d'heures</strong>, <strong>participation à un programme</strong> et <strong>anniversaires</strong>. Chacun se déclenche dès qu'un bénévole franchit le seuil, sans travail administratif.",
    },
    spot1_b1: { en: "Shift counts: first shift, 10, 50, or any number you set", fr: "Nombre de quarts : premier quart, 10, 50 ou tout nombre choisi" },
    spot1_b2: { en: "Hours of service: across all-time or per calendar year", fr: "Heures de service : depuis toujours ou par année civile" },
    spot1_b3: { en: "Program-specific milestones, scoped to one program or role", fr: "Jalons spécifiques à un programme, limités à un programme ou rôle" },
    spot1_b4: { en: "Tenure achievements that fire on each volunteer anniversary", fr: "Accomplissements d'ancienneté déclenchés à chaque anniversaire de bénévolat" },

    // ── Spotlight 2: Custom awards ──
    spot2_kicker: { en: "DESIGN", fr: "CONCEVOIR" },
    spot2_title: { en: "Design awards for the moments only you see.", fr: "Concevez des prix pour les moments que vous seuls voyez." },
    spot2_body: {
      en: "Some recognition is earned, some is given. Build an award with its own <strong>name, icon, and description</strong>, then decide how it lands: an <strong>auto rule</strong> Vome enforces, or a <strong>manual award</strong> a coordinator sends by hand to one person or a group.",
      fr: "Certaines reconnaissances se gagnent, d'autres se donnent. Bâtissez un prix avec son propre <strong>nom, icône et description</strong>, puis choisissez comment il arrive : une <strong>règle automatique</strong> appliquée par Vome, ou un <strong>prix manuel</strong> qu'un coordonnateur envoie à la main à une personne ou à un groupe.",
    },
    spot2_b1: { en: "Pick from preset icons or upload a custom image", fr: "Choisissez parmi les icônes prédéfinies ou téléversez une image" },
    spot2_b2: { en: "Auto rule on hours or shifts, with optional time windows", fr: "Règle automatique sur heures ou quarts, avec fenêtres optionnelles" },
    spot2_b3: { en: "Manual sending to one volunteer or a hand-picked group", fr: "Envoi manuel à un bénévole ou à un groupe choisi" },
    spot2_b4: { en: "Eligibility limited by tag, role, site, or sequence completion", fr: "Admissibilité limitée par étiquette, rôle, site ou séquence terminée" },
    ...
    spot3_body: {
      en: "Each award and achievement lands on the volunteer's profile with a date, a source, and a note. <strong>Built-in achievements</strong> show what triggered them. <strong>Custom awards</strong> show who sent them. Volunteers can keep the timeline, share it, or use it on a CV.",
      fr: "Chaque prix et accomplissement arrive sur le profil du bénévole avec une date, une source et une note. Les <strong>accomplissements intégrés</strong> indiquent ce qui les a déclenchés. Les <strong>prix personnalisés</strong> indiquent qui les a envoyés. Les bénévoles peuvent garder le fil, le partager ou l'utiliser sur un CV.",
    },
    ...
    spot3_b2: { en: "Each entry shows source: auto-earned or sent by an admin", fr: "Chaque entrée indique la source : auto-gagnée ou envoyée par un admin" },
    spot3_b3: { en: "Progress bars for the next achievements in line", fr: "Barres de progression pour les prochains accomplissements" },
    spot3_b4: { en: "Share-ready: each award has a shareable link from the app", fr: "Prêt à partager : chaque prix a un lien partageable depuis l'app" },

    // ── How it works (4 steps) ──
    how_h2: { en: "How it works", fr: "Comment ça fonctionne" },
    how_sub: {
      en: "Vome ships the catalog. You add what is unique to your program. Volunteers earn as they go.",
      fr: "Vome livre le catalogue. Vous ajoutez ce qui est unique à votre programme. Les bénévoles gagnent à mesure.",
    },
    step1_title: { en: "Turn on the catalog", fr: "Activer le catalogue" },
    step1_desc: { en: "Built-in achievements ship enabled on Enterprise. Pick which ones to keep, hide, or rename for your program's tone.", fr: "Les accomplissements intégrés sont actifs sur Entreprise. Choisissez ceux à garder, masquer ou renommer selon le ton de votre programme." },
    step2_title: { en: "Design custom awards", fr: "Concevoir des prix" },
    step2_desc: { en: "Pick a name, icon, and description. Choose an auto rule on hours or shifts, or a manual award you send by hand.", fr: "Choisissez un nom, une icône et une description. Choisissez une règle automatique sur heures ou quarts, ou un prix manuel à envoyer à la main." },
    step3_title: { en: "Scope eligibility", fr: "Cibler l'admissibilité" },
    step3_desc: { en: "Limit each award to volunteers with a tag, role, or site, or to those who finished a specific onboarding sequence.", fr: "Limitez chaque prix aux bénévoles avec une étiquette, un rôle ou un site, ou à ceux qui ont terminé une séquence d'intégration." },
    step4_title: { en: "Volunteers earn live", fr: "Les bénévoles gagnent en direct" },
    step4_desc: { en: "Triggers fire as hours and shifts log. Awards land on the profile with a notification, and your timeline shows what came from where.", fr: "Les déclencheurs s'activent à la consignation des heures et des quarts. Les prix arrivent au profil avec une notification, et votre fil indique d'où vient chaque entrée." },
    ...
    diff1_desc: { en: "Triggers run on the verified hours and shifts your team already approves. No separate point system, no double-counting, no reconciliation step.", fr: "Les déclencheurs tournent sur les heures et les quarts vérifiés que votre équipe approuve déjà. Aucun système de points distinct, ni double comptage, ni réconciliation." },
    diff2_title: { en: "Tied to the volunteer record", fr: "Lié au dossier du bénévole" },
    diff2_desc: { en: "Awards live on the same profile as eligibility, status, and tags. Coordinators see recognition history alongside reservations and onboarding, not on a separate tab.", fr: "Les prix vivent sur le même profil que l'admissibilité, le statut et les étiquettes. Les coordonnateurs voient l'historique de reconnaissance à côté des réservations et de l'intégration, et non dans un onglet séparé." },
    diff3_title: { en: "Earnest, not gamified", fr: "Sincère, pas gamifié" },
    diff3_desc: { en: "No leaderboards, no point grinding, no synthetic ranks. Vome treats recognition as a thank-you for real contribution, the way volunteer programs actually work.", fr: "Pas de classement, pas de chasse aux points, pas de rangs artificiels. Vome traite la reconnaissance comme un merci pour une vraie contribution, comme fonctionnent vraiment les programmes de bénévolat." },
    ...
    faq_cta_text: { en: "Still have questions?", fr: "Vous avez encore des questions ?" },
    faq_cta_link: { en: "Talk to our team", fr: "Parlez à notre équipe" },
    faq1_q: { en: "What's the difference between an achievement and a custom award?", fr: "Quelle est la différence entre un accomplissement et un prix personnalisé ?" },
    faq1_a: {
      en: "Built-in Vome achievements ship out of the box and earn automatically as a volunteer logs hours, completes shifts, or hits an anniversary. Custom awards are designed by your team. They can earn on a rule you set, or a coordinator can send them by hand for a moment Vome cannot detect.",
      fr: "Les accomplissements Vome intégrés sont livrés dès le départ et se gagnent automatiquement quand un bénévole consigne des heures, complète des quarts ou atteint un anniversaire. Les prix personnalisés sont conçus par votre équipe. Ils peuvent se gagner selon une règle que vous définissez, ou un coordonnateur peut les envoyer à la main pour un moment que Vome ne peut pas détecter.",
    },
    faq2_q: { en: "When does an achievement actually trigger?", fr: "Quand un accomplissement se déclenche-t-il réellement ?" },
    faq2_a: {
      en: "The moment a logged hour or shift crosses the threshold you set. Triggers can run on all-time totals, per calendar year, on a rolling window, or on consecutive periods. Vome uses the same hours and shifts your team already approves, so awards reflect verified work.",
      fr: "Dès qu'une heure ou un quart consigné franchit le seuil défini. Les déclencheurs peuvent porter sur les totaux depuis toujours, par année civile, sur une fenêtre glissante ou sur des périodes consécutives. Vome utilise les mêmes heures et quarts que votre équipe approuve déjà, donc les prix reflètent un travail vérifié.",
    },
    ...
    faq4_q: { en: "Where do volunteers see what they earned?", fr: "Où les bénévoles voient-ils ce qu'ils ont gagné ?" },
    faq4_a: {
      en: "On their profile, in the Vome web app and the iOS or Android app. Earned items show first, with progress bars for the achievements they are working toward next. Each award has a shareable link the volunteer can post or attach to a CV.",
      fr: "Sur leur profil, dans l'app web Vome et les apps iOS et Android. Les éléments gagnés s'affichent en premier, avec des barres de progression pour les accomplissements en cours. Chaque prix a un lien partageable que le bénévole peut publier ou joindre à un CV.",
    },
    ...
    faq5_a: {
      en: "Yes. Each award can be scoped by tag, role, site, or by completion of a specific onboarding sequence. Volunteers outside the scope will not see the award in their catalog or progress, so the experience stays clean for everyone else.",
      fr: "Oui. Chaque prix peut être ciblé par étiquette, rôle, site, ou par la complétion d'une séquence d'intégration. Les bénévoles hors du périmètre ne voient pas le prix dans leur catalogue ni leur progression, ce qui garde l'expérience épurée pour tous les autres.",
    },
    faq6_q: { en: "Which plan unlocks recognition?", fr: "Quel forfait inclut la reconnaissance ?" },
    faq6_a: {
      en: "Recognition is included on Enterprise: the built-in catalog of achievements is enabled out of the box. Custom awards (your own awards with auto rules or manual sending) unlock on Ultimate. Both share the same volunteer profile and timeline.",
      fr: "La reconnaissance est incluse sur Entreprise : le catalogue intégré d'accomplissements est activé dès le départ. Les prix personnalisés (vos propres prix avec règles automatiques ou envoi manuel) sont inclus sur Ultime. Les deux partagent le même profil de bénévole et le même fil.",
    },
  ...
  module_data: {
    ...
    // ── Hero ──
    hero_eyebrow: { en: "Data & reports", fr: "Données et rapports" },
    ...
    table_mock: {
      ...
      r3_status: { en: "Pending", fr: "En attente" },
    ...
    diff_sub: {
      en: "Generic CRMs were built for sales teams. Vome's database was built for volunteer programs: tags, sites, sequences, hours, and the reports your funders ask for.",
      fr: "Les CRM génériques sont conçus pour les équipes de vente. La base de données Vome est conçue pour le bénévolat : étiquettes, sites, séquences, heures et les rapports que vos bailleurs demandent.",
    },
    ...
    faq4_q: { en: "How does the Google Sheets integration work?", fr: "Comment fonctionne l'intégration Google Sheets ?" },
    faq4_a: {
      en: "Connect a Google Sheet to your Vome database for two-way sync. Use it as an automatic backup, share it with stakeholders who don't need a Vome login, or pipe it into downstream automations and custom integrations. Sync runs on a schedule you control.",
      fr: "Connectez une feuille Google Sheets à votre base de données Vome pour une synchronisation bidirectionnelle. Utilisez-la comme copie de sauvegarde automatique, partagez-la avec des parties prenantes sans accès Vome, ou alimentez des automatisations et intégrations en aval. La synchronisation suit l'horaire que vous définissez.",
    },
  ...
  module_integrations: {
    ...
    page_description: {
      en: "Connect Vome to Salesforce, Sterling Volunteers, SCORM Cloud, Double the Donation, Google Sheets, Zapier, and Microsoft Power Automate. SAML SSO. REST API and custom webhooks on Ultimate.",
      fr: "Connectez Vome à Salesforce, Sterling Volunteers, SCORM Cloud, Double the Donation, Google Sheets, Zapier et Microsoft Power Automate. SSO SAML. API REST et webhooks personnalisés sur Ultimate.",
    },
    ...
    hero_sub: {
      en: "<strong>Native integrations</strong> for the essentials. <em>No-code automations</em> with Zapier and Power Automate. <em>SAML SSO</em> with Microsoft Entra ID and JumpCloud. A <strong>REST API, custom webhooks, and a developer dashboard</strong> on Ultimate.",
      fr: "<strong>Intégrations natives</strong> pour l'essentiel. <em>Automatisations sans code</em> avec Zapier et Power Automate. <em>SSO SAML</em> avec Microsoft Entra ID et JumpCloud. <strong>API REST, webhooks personnalisés et tableau de bord développeur</strong> sur Ultimate.",
    },
    hero_meta_native: { en: "Native integrations included", fr: "Intégrations natives incluses" },
    hero_meta_nocode: { en: "No-code via Zapier & Power Automate", fr: "Sans code via Zapier et Power Automate" },
    hero_meta_dev: { en: "REST API & webhooks on Ultimate", fr: "API REST et webhooks sur Ultimate" },
    ...
    native_mock: {
      ...
      sf_meta: { en: "Installable Vome package", fr: "Paquet Vome installable" },
      sf_status: { en: "Connected", fr: "Connectée" },
      sterling_name: { en: "Sterling Volunteers", fr: "Sterling Volunteers" },
      sterling_meta: { en: "Background checks", fr: "Vérifications d'antécédents" },
      sterling_status: { en: "Connected", fr: "Connectée" },
      scorm_name: { en: "SCORM Cloud", fr: "SCORM Cloud" },
      scorm_meta: { en: "Training scores synced", fr: "Notes de formation synchronisées" },
      scorm_status: { en: "Connected", fr: "Connectée" },
      dtd_name: { en: "Double the Donation", fr: "Double the Donation" },
      dtd_meta: { en: "Matching gifts on hour claims", fr: "Dons jumelés à la déclaration d'heures" },
      dtd_status: { en: "Connected", fr: "Connectée" },
      sheets_name: { en: "Google Sheets", fr: "Google Sheets" },
      sheets_meta: { en: "Vome database two-way sync", fr: "Synchronisation bidirectionnelle de la base" },
    ...
    benefits_sub: {
      en: "Pick the path that fits your team. Native integrations for the essentials, no-code automations for everything else, and a full API when you need to build something custom.",
      fr: "Choisissez la voie qui convient à votre équipe. Intégrations natives pour l'essentiel, automatisations sans code pour le reste, et une API complète quand vous devez bâtir sur mesure.",
    },
    ben1_title: { en: "CRM that stays in sync", fr: "CRM qui reste synchronisé" },
    ben1_desc: { en: "Push volunteer activity, hours, and donations into Salesforce with the installable Vome Lightning package. No CSV exports, no copy-paste.", fr: "Envoyez l'activité, les heures et les dons dans Salesforce avec le paquet Vome Lightning installable. Sans export CSV ni copier-coller." },
    ben2_title: { en: "Background checks in-flow", fr: "Vérifications d'antécédents intégrées" },
    ben2_desc: { en: "Trigger Sterling Volunteers checks from an onboarding sequence. Results land on the volunteer profile and unlock the next step automatically.", fr: "Déclenchez les vérifications Sterling Volunteers depuis une séquence d'intégration. Les résultats arrivent sur le profil et débloquent l'étape suivante." },
    ...
    spot1_body: {
      en: "These aren't generic webhooks dressed up as a logo. <strong>Salesforce, Sterling Volunteers, SCORM Cloud, Double the Donation, and Google Sheets</strong> are built directly into Vome. Configure them once, and the data flows where you'd expect it: onto the volunteer profile, into your sequences, and across reports.",
      fr: "Ce ne sont pas des webhooks génériques déguisés en logos. <strong>Salesforce, Sterling Volunteers, SCORM Cloud, Double the Donation et Google Sheets</strong> sont bâtis directement dans Vome. Configurez-les une fois, les données circulent où il faut : au profil du bénévole, dans vos séquences et dans les rapports.",
    },
    spot1_b1: { en: "Salesforce Lightning: installable Vome package, two-way contact and activity sync", fr: "Salesforce Lightning : paquet Vome installable, synchronisation bidirectionnelle des contacts et activités" },
    spot1_b2: { en: "Sterling Volunteers: trigger background checks from an onboarding step, results land on the profile", fr: "Sterling Volunteers : déclenchez les vérifications depuis une étape d'intégration, les résultats arrivent au profil" },
    spot1_b3: { en: "SCORM Cloud: host courses, deliver as sequence steps, keep scores on the volunteer record", fr: "SCORM Cloud : hébergez les cours, livrez-les comme étapes de séquence, conservez les notes au dossier" },
    spot1_b4: { en: "Google Sheets two-way sync and Double the Donation matching gifts on hour claims", fr: "Synchronisation bidirectionnelle Google Sheets et dons jumelés Double the Donation aux déclarations d'heures" },
    ...
    spot2_body: {
      en: "Vome ships with native <strong>Zapier</strong> and <strong>Microsoft Power Automate</strong> connectors. Trigger flows on a new applicant, a status change, an hour claim, or a donation. Then chain whichever apps your team already lives in: Mailchimp, Slack, HubSpot, Google Sheets, Outlook, Teams.",
      fr: "Vome est livré avec des connecteurs natifs <strong>Zapier</strong> et <strong>Microsoft Power Automate</strong>. Déclenchez des flux à une nouvelle candidature, un changement de statut, une déclaration d'heures ou un don. Enchaînez ensuite les applications que votre équipe utilise déjà : Mailchimp, Slack, HubSpot, Google Sheets, Outlook, Teams.",
    },
    spot2_b1: { en: "Triggers on new applicants, status changes, hour claims, donations, and form submissions", fr: "Déclencheurs : nouveaux candidats, changements de statut, heures, dons et soumissions de formulaire" },
    spot2_b2: { en: "Chain multiple actions per flow: add to Mailchimp, post to Slack, append to a Google Sheet", fr: "Enchaînez plusieurs actions par flux : ajout à Mailchimp, message Slack, ligne dans un Google Sheet" },
    spot2_b3: { en: "Microsoft Power Automate connector for organizations standardized on Microsoft 365", fr: "Connecteur Microsoft Power Automate pour les organisations standardisées sur Microsoft 365" },
    spot2_b4: { en: "Build, test, and monitor your flows from Zapier or Power Automate, no Vome dev access required", fr: "Bâtissez, testez et suivez vos flux depuis Zapier ou Power Automate, sans accès dev à Vome" },
    ...
    spot3_body: {
      en: "On Ultimate, your developers get <strong>API keys</strong>, a <strong>developer dashboard</strong>, signed <strong>custom webhooks</strong>, and event logs. Build the integration your program actually needs. Replay failed deliveries, inspect payloads, and rotate keys without leaving the dashboard.",
      fr: "Sur Ultimate, vos développeurs obtiennent <strong>clés API</strong>, <strong>tableau de bord développeur</strong>, <strong>webhooks personnalisés</strong> signés et journaux d'événements. Bâtissez l'intégration dont votre programme a besoin. Rejouez les livraisons échouées, inspectez les charges utiles et faites tourner les clés sans quitter le tableau.",
    },
    spot3_b1: { en: "REST API with scoped keys for volunteers, opportunities, hours, and applications", fr: "API REST avec clés à portée pour bénévoles, opportunités, heures et candidatures" },
    spot3_b2: { en: "Custom webhooks signed with HMAC, automatic retries up to 5 attempts on failure", fr: "Webhooks personnalisés signés HMAC, réessais automatiques jusqu'à 5 tentatives en cas d'échec" },
    spot3_b3: { en: "Developer dashboard with event logs, payload inspector, and one-click delivery replay", fr: "Tableau de bord développeur avec journaux d'événements, inspecteur de charge utile et rejeu en un clic" },
    spot3_b4: { en: "Subscribe to specific event types so endpoints only receive what they need", fr: "Abonnez-vous à des types d'événements précis pour que vos endpoints ne reçoivent que le nécessaire" },

    // ── Logo grid (replaces "How it works") ──
    logos_h2: { en: "Every integration Vome ships with", fr: "Chaque intégration livrée avec Vome" },
    logos_sub: {
      en: "Grouped by category. Native integrations are configured from the Vome admin. Email, identity, and the developer surface live alongside them in the same settings area.",
      fr: "Groupées par catégorie. Les intégrations natives se configurent depuis l'admin Vome. Courriel, identité et surface développeur cohabitent dans la même zone de paramètres.",
    },
    logos_cat_native: { en: "Native integrations", fr: "Intégrations natives" },
    logos_cat_email: { en: "Email & identity", fr: "Courriel et identité" },
    ...
    logo_google_mail_sub: { en: "Email domain", fr: "Domaine courriel" },
    logo_outlook: { en: "Microsoft 365", fr: "Microsoft 365" },
    logo_outlook_sub: { en: "Email domain", fr: "Domaine courriel" },
    ...
    diff3_title: { en: "Enterprise-grade auth", fr: "Authentification de niveau entreprise" },
    diff3_desc: { en: "SAML SSO with Microsoft Entra ID, JumpCloud, and any SAML 2.0 provider. Email from your own Google or Microsoft domain. Audit logs and key rotation included.", fr: "SSO SAML avec Microsoft Entra ID, JumpCloud et tout fournisseur SAML 2.0. Courriels depuis votre domaine Google ou Microsoft. Journaux d'audit et rotation des clés inclus." },
    ...
    faq1_a: {
      en: "Sterling Volunteers, SCORM Cloud, Double the Donation, and Google Sheets are available on Pro and above. Salesforce, SAML SSO, and Zapier or Power Automate are part of Enterprise. The REST API, custom webhooks, and the developer dashboard are Ultimate. The full breakdown is in the comparison table above.",
      fr: "Sterling Volunteers, SCORM Cloud, Double the Donation et Google Sheets sont offerts sur Pro et plus. Salesforce, SSO SAML et Zapier ou Power Automate font partie d'Enterprise. L'API REST, les webhooks personnalisés et le tableau de bord développeur sont sur Ultimate. La répartition complète est dans le tableau ci-dessus.",
    },
    faq2_q: { en: "Do I need a developer to set up the native integrations?", fr: "Faut-il un développeur pour configurer les intégrations natives ?" },
    faq2_a: {
      en: "No. Sterling, SCORM, Double the Donation, Google Sheets, and the email domain integration are configured from the Vome admin in a guided flow. Salesforce takes a few extra steps because the Vome Lightning package gets installed in your Salesforce org, but it's still a no-code setup.",
      fr: "Non. Sterling, SCORM, Double the Donation, Google Sheets et l'intégration de domaine courriel se configurent depuis l'admin Vome dans un flux guidé. Salesforce demande quelques étapes de plus car le paquet Vome Lightning s'installe dans votre org Salesforce, mais cela reste sans code.",
    },
    faq3_q: { en: "What can I do with the Vome Zapier connector?", fr: "Que puis-je faire avec le connecteur Zapier Vome ?" },
    faq3_a: {
      en: "Trigger Zaps on new applicants, status changes, hour claims, donations, and form submissions. Chain Vome with Mailchimp, Slack, HubSpot, Outlook, Teams, Google Sheets, or any other Zapier app. The same triggers and actions are available through the Microsoft Power Automate connector for Microsoft 365 shops.",
      fr: "Déclenchez des Zaps à de nouveaux candidats, changements de statut, déclarations d'heures, dons et soumissions. Enchaînez Vome avec Mailchimp, Slack, HubSpot, Outlook, Teams, Google Sheets ou toute autre app Zapier. Les mêmes déclencheurs et actions sont offerts par le connecteur Microsoft Power Automate pour les organisations Microsoft 365.",
    },
    faq4_q: { en: "How do the REST API and custom webhooks work?", fr: "Comment fonctionnent l'API REST et les webhooks personnalisés ?" },
    faq4_a: {
      en: "On Ultimate, the developer dashboard issues scoped API keys, lets you create custom webhook subscriptions per event type, and shows logs of every delivery. Webhooks are signed with HMAC, retried up to 5 times on failure, and you can replay any past delivery from the dashboard.",
      fr: "Sur Ultimate, le tableau de bord développeur émet des clés API à portée, permet de créer des abonnements webhook par type d'événement, et affiche les journaux de chaque livraison. Les webhooks sont signés HMAC, réessayés jusqu'à 5 fois en cas d'échec, et vous pouvez rejouer toute livraison depuis le tableau.",
    },
